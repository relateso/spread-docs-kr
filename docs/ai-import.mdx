---
title: "AI 임포트 (Import)"
description: "AI를 활용해 연락처 임포트를 더 빠르게 진행할 수 있습니다"
...
<Accordion title="1. 임포트 데이터 종류">
  Spread에서 임포트할 수 있는 정보는 3가지로 나눠집니다. 
...
&nbsp;&nbsp;예를 들어, 서로 다른 두 조직인 Spread(@example.so)과 Pixelic(@example.so)의 도메인이 같다면 중복 임포트 불가로 임포트에 실패하게 됩니다.
